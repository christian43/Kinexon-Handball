# This file can be used to read multiple files from kinexon UI data export. This
# code is written to use the files starting with Event*.csv. One function that
# is needed should be located in /src. Additonally the event data is merged with
# the *Export files to add some informations from them. So these data should be
# included in the directory. At least the colnames for each event is saved
# 'kinexonEventNames.rda'. This file is load in line 87. Please use your Path.
# The output contain 11 data frames.    
